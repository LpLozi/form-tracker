...
// NOTE: input advance/focus/inputmode for kg_/rep_/rir_ fields is now owned
// exclusively by the set-entry controller in ft-strong-keypad.js. The old
// nextNumericInput/focusNext/decorateSetInputs functions (native-keyboard-era
// inputmode override + a "✓ confirm" button that this file's own CSS hid with
// `display:none!important`, i.e. dead code) have been removed to eliminate
// the conflict with the keypad's readonly/inputmode="none" set-up.
...
else{const base=window.renderWorkout;if(typeof base==='function')window.renderWorkout=function(){const r=base.apply(this,arguments);setTimeout(enhance,160);return r}}
